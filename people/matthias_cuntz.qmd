...
<!-- <img style="padding: 0px 10px 0px 0px; width: 25%; height: 50%; float: left;" align="middle" src="images/Matthias_Cuntz-LaReunion_Callas.jpg"/> {layout-ncol=2} -->
...
[Personal page](matthias_cuntz.qmd) &nbsp; &nbsp; &nbsp;
<a href="mailto:matthias.cuntz@inrae.fr">E-Mail</a> &nbsp; &nbsp; &nbsp;
[Google scholar](https://scholar.google.com/citations?user=s93VuhMAAAAJ)
