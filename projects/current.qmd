...
1. [PHydrauCC -- Plant Hydraulic Functioning in face of Climate Change](phydraucc.qmd)
...
2. [SlowStom -- Influence of slow stomatal responses on ecosystem fluxes and water-use efficiency](slowstom.qmd)
...
3. [TAW-tree -- Total Available Water to Tree: a key, missing parameter for assessing the vulnerability of forests in the face of climate change](taw-tree.qmd)
...
4. [LSMxAI -- Better projections of future climate change – using explainable AI to improve land surface models](lsmxai.qmd)
...
5. [Drought ForC -- Drought impacts on carbon stocks and fluxes in forest ecosystems: experiments and modeling](droughtforc.qmd)
...
6. [European forest responses to drought](europedrought.qmd)
